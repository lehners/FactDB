...
/*---------------------------------------------------------------------------*/
struct artificial3 final : public BaseTable {
   enum Columns { a,
                  b,
                  id };
   ...
   struct Container {
      ...
      decltype(auto) id(this auto&& self) { return std::get<1>(self.tuple); }
   ...
   ~artificial3() override = default;
   std::string_view name() const override { return "artificial3"; };
...
factDB::BaseTable* create_artificial3();
void destroy_artificial3(factDB::BaseTable* ptr);
/*---------------------------------------------------------------------------*/
} // namespace factDB::tables
/*---------------------------------------------------------------------------*/
