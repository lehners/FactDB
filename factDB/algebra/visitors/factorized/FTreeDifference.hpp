...
// ---------------------------------------------------------------------------------------------------
class FTreeDifference : public AlgebraVisitor {
   protected:
   FileWriter out;
   FactorizedTreeDeriver naiveDeriver;
   FactorizedTreeDeriver improvedDeriver;

   public:
   explicit FTreeDifference(std::ostream& writer) : out(writer, FileWriter::Silent) {};
